...
> Pick the pattern in this guide first. After that, choose the runtime surface in
> `docs/runtimes/` and apply that runtime's limits and setup steps.
...
|     Start with: docs/core/patterns/patchwork.md
|
...
|     Start with: docs/core/patterns/worker-swarm.md
|
...
|     Start with: docs/core/patterns/research-swarm.md
|
...
|     Start with: docs/core/patterns/hive-mind-2tier.md
|
+-- Two or more workstreams, each needing its own lead --> HIVE MIND 3-TIER (done)
|     Start with: docs/core/patterns/hive-mind-3tier.md
|
Q5: Do parallel agents need file-level git isolation?
|
+-- Yes --> Add WORKTREE SPRINT layer to whichever pattern above you chose
|     Start with: docs/core/patterns/worktree-sprint.md
|
+-- No --> Run the pattern directly
```

After you answer Q5, choose a runtime:

- Claude Code: `docs/runtimes/claude-code/overview.md`
- Codex: `docs/runtimes/codex/overview.md`
- OpenClaw: `docs/runtimes/openclaw/overview.md`
